...
// in jawara_pintar_mobile_version/test/manajemen_pengguna/data/datasources/users_datasources_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUsersDataSource extends _i1.Mock implements _i5.UsersDataSource {
  @override
  _i3.Future<List<_i6.UsersModel>> getAllUsers() =>
      (super.noSuchMethod(
            Invocation.method(#getAllUsers, []),
            returnValue: _i3.Future<List<_i6.UsersModel>>.value(
              <_i6.UsersModel>[],
            ),
            returnValueForMissingStub: _i3.Future<List<_i6.UsersModel>>.value(
              <_i6.UsersModel>[],
            ),
          )
  ...
  @override
  _i3.Future<_i6.UsersModel?> getUserById(int? id) =>
      (super.noSuchMethod(
            Invocation.method(#getUserById, [id]),
            returnValue: _i3.Future<_i6.UsersModel?>.value(),
            returnValueForMissingStub: _i3.Future<_i6.UsersModel?>.value(),
          )
          as _i3.Future<_i6.UsersModel?>);

  @override
  _i3.Future<void> createUser(_i6.UsersModel? user) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> updateUser(_i6.UsersModel? user) =>
      (super.noSuchMethod(
