...
class _PengeluaranListPageState extends State<PengeluaranListPage> {
  ...
  void initState() {
    super.initState();
    // Load initial data
    context.read<LaporanKeuanganBloc>().add(const LoadPengeluaranListEvent());
    _fetchKategori();
  }
          ...
          child: BlocBuilder<LaporanKeuanganBloc, LaporanKeuanganState>(
            builder: (context, state) {
              if (state is LaporanKeuanganLoading) {
                ...
                final pengeluaranList = state.pengeluaranList;
                ...
                // Calculate total
                final total = pengeluaranList.fold<double>(
                  0,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            const Color(0xFFEB5B9D).withOpacity(0.1),
                            const Color(0xFFE85D9A).withOpacity(0.1),
                          ],
                        ),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: const Color(0xFFEB5B9D).withOpacity(0.3),
                        ),
                      ),
                      child: Row(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Kategori (optional - can be implemented with dropdown)
            Text(
              'Kategori',
              style: TextStyle(
                fontSize: 13,
