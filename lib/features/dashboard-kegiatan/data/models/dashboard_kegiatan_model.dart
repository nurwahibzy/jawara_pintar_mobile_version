...
class DashboardKegiatanModel extends DashboardKegiatanEntity {
  const DashboardKegiatanModel({
    required super.totalKegiatan,
    required super.kegiatanPerKategori,
    required super.kegiatanBerdasarkanWaktu,
    required super.penanggungJawabTerbanyak,
    required super.kegiatanPerBulan,
  });
